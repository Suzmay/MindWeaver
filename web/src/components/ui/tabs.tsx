...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-popover text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-xl p-1 flex gap-2",
        className,
      )}
      {...props}
    />
